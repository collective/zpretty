...
class TestFunctions(TestCase):
    ...
    def test_lstrip_first_line_oneline(self):
        self.assertEqual(lstrip_first_line(u" a"), "a")

    def test_lstrip_first_line_twolines(self):
        self.assertEqual(lstrip_first_line(u" a \n b"), (u"a \n b"))

    def test_rstrip_larst_line_oneline(self):
        self.assertEqual(rstrip_last_line(u"a"), "a")

    def test_rstrip_larst_line_twoline(self):
        self.assertEqual(rstrip_last_line(u"a\n b "), (u"a\n b"))
